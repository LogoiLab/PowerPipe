...
Invoke-WebRequest $ModuleSource -OutFile (Join-Path -Path $ModuleHome -ChildPath '\Source\PowerPipe.psm1')
Invoke-WebRequest $ModuleManifest -OutFile (Join-Path -Path $ModuleHome -ChildPath '\Source\PowerPipe.psd1')